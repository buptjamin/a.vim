...
imap <Leader>is <ESC>:IHS<CR>:HA<CR>
nmap <Leader>is :IHS<CR>:HA<CR>
...
comm! -nargs=? -bang HA call AlternateFile("n<bang>", <f-args>)
comm! -nargs=? -bang HAS call AlternateFile("h<bang>", <f-args>)
comm! -nargs=? -bang HAV call AlternateFile("v<bang>", <f-args>)
comm! -nargs=? -bang HAT call AlternateFile("t<bang>", <f-args>)
comm! -nargs=? -bang HAN call NextAlternate("<bang>")
